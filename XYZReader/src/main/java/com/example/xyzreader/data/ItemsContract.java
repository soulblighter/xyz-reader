...
public class ItemsContract {
    ...
    public static final Uri BASE_URI = Uri.parse("content://com.example" +
        ".xyzreader");
    ...
    public static class Items implements ItemsColumns {
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd" +
            ".com.example.xyzreader.items";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor" +
            ".item/vnd.com.example.xyzreader.items";
        ...
        public static Uri buildItemUri(long _id) {
            return BASE_URI.buildUpon().appendPath("items").appendPath(Long
                .toString(_id)).build();
        }
    ...
    public static long getCount(Context context) {
        Cursor c = null;
        try {
            c = context.getContentResolver().query(Items.buildDirUri(), new
                String[]{ItemsColumns._ID}, null, null, null);
            return c.getCount();
        } catch (Exception e) {
            return 0;
        } finally {
