...
// https://stackoverflow.com/questions/31837840/paginating-text-in-android
public class Pagination {
    ...
    public Pagination(String text, int pageW, int pageH, TextPaint paint, float spacingMult, float spacingAdd, boolean inclidePad) {
        this.mText = Html.fromHtml(("\n"+text).replaceAll("(\r\n|\n)", "<br />"));
        this.mWidth = pageW;
        this.mHeight = pageH;
        this.mPaint = paint;
